...
#define NC1_ON HAL_GPIO_WritePin(GPIOB,GPIO_PIN_5, PIN_HIGH)
#define NC1_OFF HAL_GPIO_WritePin(GPIOB,GPIO_PIN_5, PIN_LOW)
...
#define FAN1_ON HAL_GPIO_WritePin(GPIOC,GPIO_PIN_10, PIN_HIGH)
#define FAN1_OFF HAL_GPIO_WritePin(GPIOC,GPIO_PIN_10, PIN_LOW)
#define FAN2_ON HAL_GPIO_WritePin(GPIOC,GPIO_PIN_11, PIN_HIGH)
#define FAN2_OFF HAL_GPIO_WritePin(GPIOC,GPIO_PIN_11, PIN_LOW)
#define FAN3_ON HAL_GPIO_WritePin(GPIOC,GPIO_PIN_12, PIN_HIGH)
#define FAN3_OFF HAL_GPIO_WritePin(GPIOC,GPIO_PIN_12, PIN_LOW)
#define FAN4_ON HAL_GPIO_WritePin(GPIOD,GPIO_PIN_2, PIN_HIGH)
#define FAN4_OFF HAL_GPIO_WritePin(GPIOD,GPIO_PIN_2, PIN_LOW)
